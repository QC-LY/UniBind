...
if __name__ == '__main__':
    ...
    parser.add_argument("--modality", type=str, default='event', required=False)
    parser.add_argument("--centre_embeddings_path", type=str, default='./centre_embs/event_caltech_center_embeddings.pkl', required=False)
    ...
    images = ["./assets/event_gerenuk.png", "./assets/event_ibis.png"]
    inputs = {
