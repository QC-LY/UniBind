...
if __name__ == '__main__':
    ...
    parser.add_argument("--modality", type=str, default='audio', required=False)
    parser.add_argument("--centre_embeddings_path", type=str, default='./centre_embs/audio_esc_center_embeddings.pkl', required=False)
    ...
    audios = ["./assets/audio_airplane.wav", "./assets/audio_car.wav"]
    inputs = {
        ModalityType.AUDIO: load_and_transform_audio_data(audios, device),
    }
